/** Shop catalog — image paths match files in public/assets/ */

export type CardSkinDef = {
  name: string;
  description: string;
  imageUrl: string;
  price: number;
...
export const CARD_SKIN_CATALOG: CardSkinDef[] = [
  {
    name: "Classic Blue",
    description: "The timeless casino standard",
    imageUrl: "/assets/cookie-icon.png",
    price: 0,
    themeColor: "#1E88E5",
    isDefault: true,
  },
...
export const TABLE_SKIN_CATALOG: TableSkinDef[] = [
  {
    name: "Classic Green",
  ...
  },
  {
    ...
    cssGradient:
      "radial-gradient(circle at center, #7B1FA2 0%, #4A148C 100%)",
    price: 1000,
  },
  {
    name: "Ocean Blue",
    ...
    cssGradient:
      "radial-gradient(circle at center, #0288D1 0%, #01579B 100%)",
    price: 2500,
  },
  {
    name: "Sunset Orange",
    ...
    cssGradient:
      "radial-gradient(circle at center, #F57C00 0%, #E65100 100%)",
    price: 5000,
  },
  {
    name: "Midnight Black",
    ...
    cssGradient:
      "radial-gradient(circle at center, #424242 0%, #212121 100%)",
    price: 10000,
  },
  {
    name: "Rose Garden",
    ...
    cssGradient:
      "radial-gradient(circle at center, #E91E63 0%, #880E4F 100%)",
    price: 25000,
  },
  {
    name: "Golden Palace",
    ...
    cssGradient:
      "radial-gradient(circle at center, #FBC02D 0%, #F57F17 100%)",
    price: 50000,
  },
  {
    name: "Cookie Crumbs",
    ...
    cssGradient:
      "radial-gradient(circle at center, #D2691E 0%, #8B4513 100%)",
    price: 100000,
  },
  {
    name: "Cosmic Void",
  ...
  },
  {
    ...
    cssGradient:
      "radial-gradient(circle at center, #FFD700 0%, #B8860B 100%)",
    price: 1000000,
  },
];
